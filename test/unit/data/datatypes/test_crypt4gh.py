...
def test_crypt4gh_set_meta_can_clear_compute_keypair_for_returned_outputs(
    c4gh_loader,
    c4gh_data_complete,
...
def test_crypt4gh_set_meta_clear_compute_keypair_prefers_explicit_header_when_provided(
    c4gh_loader,
    c4gh_data_complete,
    c4gh_data_header_recrypted,
):
